...
//#define IEEE_8023_MAC_ADDRESS	{0x00,0x50,0x56,0xc0,0x00,0x01}
#define IEEE_8023_MAC_ADDRESS	{0,80,86,192,0,1}
...
void gw_icmp6_input();
void uip_gw_create_na(uip_ipaddr_t* src, uip_ipaddr_t* dst, uip_ipaddr_t* tgt, u8_t flags);
void uip_gw_append_icmp_opt(u8_t type, void* data, u8_t status, u16_t lifetime);
